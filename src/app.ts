...
import { greet, window_alart } from "../main-wasm/pkg/main_wasm.js";
...
export class applt extends Application {
  ...
  constructor(outputWidth: number, outputHeight: number, options?: ApplicationOptions) {
